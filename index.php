    ...
    <header>
        <div class="topbar">
            <div id="logo">
                ...
                <ul>
                    <li id="first"><a href="report.php">Report Criminal Content</a></li>

                    <li id="second"><a href="support.php">Support</a></li>
                </ul>
            </div>
        </div>
        ...
        <div class="menubar">
            <ul>
                ...
                <li><i class="fa fa-user"></i><a href="login.php">LOGIN<i class="fa fa-angle-down"></i></a>
                    <ul>
